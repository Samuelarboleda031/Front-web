...
export function LoginPage() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    // Simulación de envío de email (sin APIs externas)
    try {
    ...
    <div className="min-h-screen bg-black-primary flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="elegante-card">
          <h3 className="text-lg font-semibold text-white-primary mb-4 text-center">Cuentas de Demostración</h3>
          <div className="space-y-3">
            {/* Cuenta Admin */}
            <div className="p-3 rounded-lg bg-gray-medium border border-gray-dark">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white-primary">Miguel Rodriguez</p>
                    <p className="text-xs text-orange-primary">Administrador</p>
                  </div>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="px-3 py-1 text-xs bg-orange-primary text-black-primary rounded-lg hover:bg-orange-secondary transition-colors"
                >
                  Usar
                </button>
              </div>
              <div className="text-xs text-gray-lighter space-y-1">
                <p>• admin@elitebarbershop.com</p>
                <p>• admin123</p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-lg bg-gray-medium border border-gray-dark">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white-primary">Juan Pérez</p>
                ...
                <button
                  ...
                  className="px-3 py-1 text-xs bg-gray-light text-black-primary rounded-lg hover:bg-gray-lighter transition-colors"
                >
                  Usar
                </button>
              </div>
            ...
            <div className="p-3 rounded-lg bg-gray-medium border border-gray-dark">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-white-primary">María Gómez</p>
                    <p className="text-xs text-gray-lighter">Cliente</p>
                  </div>
                </div>
                <button
          ...
          <div className="mt-4 p-3 rounded-lg bg-gray-darker border border-gray-dark">
            <p className="text-xs text-gray-lightest text-center">
              💡 Haz clic en "Usar" para completar automáticamente los campos de login
            </p>
          </div>
        </div>
        ...
        <Dialog open={isForgotPasswordOpen} onOpenChange={closeResetModal}>
          <DialogContent className="bg-gray-darkest border-gray-dark max-w-md">
            <DialogHeader>
              <DialogTitle className="text-white-primary flex items-center gap-2">
                <KeyRound className="w-5 h-5 text-orange-primary" />
                {resetSuccess ? 'Email Enviado' : 'Recuperar Contraseña'}
              </DialogTitle>
              <DialogDescription className="text-gray-lightest">
                {resetSuccess 
            ...
            {!resetSuccess ? (
              <form onSubmit={handleForgotPassword} className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="reset-email" className="text-white-primary">Email</Label>
                  <div className="relative">
                    <Input
                      id="reset-email"
                      type="email"
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-center w-16 h-16 bg-green-900/20 border border-green-600/30 rounded-full mx-auto">
                  <Send className="w-8 h-8 text-green-400" />
                </div>
                
                <div className="text-center space-y-2">
                  <p className="text-gray-lightest text-sm">
                    Si el email <span className="text-orange-primary font-medium">{resetEmail}</span> está registrado en nuestro sistema, recibirás las instrucciones para restablecer tu contraseña.
                  </p>
